...
# --- Constantes ---
TESLA_SHARES_PERCENTAGE = 0.128      # 12.8% des actions détenues
TESLA_OPTIONS_PERCENTAGE = 0.077     # 7.7% des options
...
X_DEVALUATION = 0                    # Plus de dévaluation, valeur initiale conservée
X_VALUE = X_INITIAL_VALUE * (1 - X_DEVALUATION)
X_SHARES = 0.79

XAI_VALUE = 75_000_000_000           # Mise à jour de la valorisation
XAI_SHARES = 0.54
...
def calculate_wealth():
    ...
    tesla_shares = 3_216_000_000  # 3.216 milliards d'actions  
